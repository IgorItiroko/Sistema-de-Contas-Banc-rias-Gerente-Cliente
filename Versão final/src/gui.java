...
public static void escolhaGC() {
	 Object[] optionsGC = {"<Selecione a Opção Desejada>", "Gerente","Cliente","Sair"}																						;
	     listaGC = new JComboBox(optionsGC);
	     JOptionPane.showMessageDialog(null, listaGC, "Qual conta você deseja acessar?",
...
public static void escolhaGerente() {
	 Object[] optionsGerente = {"<Selecione a Opção Desejada>", "Cadastrar Usuario","Alterar Senha","Verificar Nome","Aplicação","Transferencia",
     		"Retirada","Editar Limite","Editar Taxa","Verificar informações de cada conta","Voltar" };
